		...
		<div class="search-bar pr">
			...
			<form>
				<input id="searchInput" name="keyword" type="text" placeholder="搜索"
					...
					class="submit am-btn" value="${proInitDto.proPageParam.keyword}"
					index="1" type="submit">
			</form>
		</div>
	</div>
				...
				<div class="am-u-sm-12 am-u-md-12">
					<div class="theme-popover">
						...
						<ul class="select">
										...
										<c:choose>
											<c:when test="${empty proInitDto.proPageParam.cateId }">
												<dd class="select-all selected">
													<a href="<%=path%>/product/getPagingList.action?cityId=${proInitDto.proPageParam.cityId}
							...
							<input type="hidden" name="cityId" value="proInitDto.proPageParam.cityId }"/>
							<li class="select-list">
								<dl id="select3">
