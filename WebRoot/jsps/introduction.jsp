		...
		<div class="item-inform">
			<div class="clearfixLeft" id="clearcontent">
				...
				<div class="box">
					...
					<div class="tb-booth tb-pic tb-s310">
						<a href="<%=path%>/${productParam.proImage }"><img
							src="<%=path%>/${productParam.proImage }" alt="细节展示放大镜特效"
							rel="<%=path%>/${productParam.proImage }" class="jqzoom" /></a>
					</div>
					<ul class="tb-thumb" id="thumblist">

						<c:forEach var="pic" items="${productParam.proImage }">
							<li>
						...
						<%-- <li class="tb-selected">
							<div class="tb-pic tb-s40">
								<a href="#"><img src="<%=path%>/images/01_small.jpg"
									mid="<%=path%>/images/01_mid.jpg" big="<%=path%>/images/01.jpg"></a>
							</div>
						</li> --%>
			...
			<div class="clearfixRight">
				...
				<div class="tb-detail-list">
					...
					<div class="tb-detail-price">
						<li class="price iteminfo_price">
							<dt>价格</dt>
							<dd>
								<em>¥</em><b class="sys_item_price">${productParam.price }</b>
							</dd>
						</li>
									...
									<form class="theme-signin" name="loginform" action=""
										...
										<div class="theme-signin-left">
											...
											<%-- <div class="theme-options">
												...
												<ul>
													<li class="sku-line selected">${productParam.specification }<i></i></li>
											...
											<div class="theme-options">
												<div class="cart-title">规格</div>
												<ul>
													<li class="sku-line selected">${productParam.specification
														}<i></i>
													</li>
											...
											<div class="theme-options">
												...
												<dd>
													<input id="min" class="am-btn am-btn-default" name=""
														...
														class="tb-hidden">库存<span class="stock">${productParam.stock
															}</span>
													</span>
												</dd>
				...
				<div class="pay">
					...
					<c:choose>
						<c:when
							test="${loginSession==null or productParam.isCollect eq 0  }">
							<a
								href="<%=path%>/myCollection/collect.action?id=${productParam.proId }"><span
			...
			<div class="introduceMain">
				<div class="am-tabs" data-am-tabs>
					<ul class="am-avg-sm-3 am-tabs-nav am-nav am-nav-tabs">
						...
						<li><a href="#"> <span class="index-needs-dt-txt" data-id="pingjia">全部评价</span></a>

						</li>

						<li><a href="#"> <span class="index-needs-dt-txt" data-id="xihuan">猜你喜欢</span></a>
						</li>
					</ul>
					...
					<div class="am-tabs-bd">
						...
						<div class="am-tab-panel am-fade am-in am-active" data-cid="xiangqing">
							<div class="J_Brand">
								...
								<div class="clear"></div>
								<ul id="J_AttrUL">
									<li title="">产品类型:&nbsp;${productParam.cateName }</li>
									<li title="">产地:&nbsp;${productParam.cityName }</li>
									<li title=""></li>
									<li title="">简介：</li>
								</ul>
								<p>&nbsp;&nbsp;&nbsp;&nbsp;${productParam.introduction }</p>
								<div class="clear"></div>
							</div>
							...
							<div class="details">
								...
								<div class="twlistNews">
									<c:forEach var="pic" items="${productParam.pictureList }">
										<img src="<%=path %>/${pic}" />
						...
						<!-- 全部评价对应内容 -->
						<div class="am-tab-panel am-fade" data-cid="pingjia">
						...
						<!-- 猜你喜欢对应内容 -->
						<div class="am-tab-panel am-fade" data-ci="xihuan">
							<div class="like">
